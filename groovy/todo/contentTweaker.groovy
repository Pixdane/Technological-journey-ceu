...
// 
// var soulcasing = VanillaFactory.createBlock("soulcasing", item('blockmaterial:iron'));
// soulcasing.register();
// 
// var draconiccasing = VanillaFactory.createBlock("draconiccasing", item('blockmaterial:iron'));
// draconiccasing.register();
// 
// var awakenedcasing = VanillaFactory.createBlock("awakenedcasing", item('blockmaterial:iron'));
// awakenedcasing.register();
// 
// var chaoticcasing = VanillaFactory.createBlock("chaoticcasing", item('blockmaterial:iron'));
...
// 
// var eternityblock = VanillaFactory.createBlock("eternityblock", item('blockmaterial:iron'));
