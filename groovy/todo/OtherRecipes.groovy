...
ABS.recipeBuilder()
        ...
        .inputs(ore('dustSteel') * 4)
        .inputs(ore('dustCaesium') * 2)
        .inputs(ore('dustBismuth') * 2)
...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(item('gtadditions:ga_meta_item:32201') * 4)
        .inputs(ore('componentCapacitor') * 4)
        .inputs(ore('componentResistor') * 4)
        .inputs(item('gregtech:meta_item_1', 593) * 2)
        .inputs(ore('plateAluminium') * 2)
        .inputs(item('gregtech:cable', 516) * 2)
...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(item('gtadditions:ga_meta_item:32201') * 4)
        .inputs(item('gcyl:gcyl_meta_item', 242) * 4)
        .inputs(item('gcyl:gcyl_meta_item', 241) * 4)
        .inputs(item('gregtech:meta_item_1', 593) * 2)
        .inputs(ore('plateAluminium') * 2)
        .inputs(item('gregtech:cable', 516) * 2)
        .fluidInputs(fluid('soldering_alloy') * 40)
...
for
recipe in RecipeMaps.getCokeOvenRecipes() {
    recipe.remove()
}
...
CIRCUIT_ASSEMBLER.recipeBuilder()
        .inputs(item('gregtech:meta_item_1', 405))
        .inputs(ore('wireFineAluminium') * 8)
        .inputs(item('gregtech:meta_item_1', 597))
        .fluidInputs(fluid('soldering_alloy') * 200)
        .outputs(ore('circuitHv') * 4)
        .duration(50)
        .EUt(9600)
