...
// 	h(e.firstItem);
// }
// var plant = [item('futuremc:wither_rose:0'),item('minecraft:red_flower:0'),item('minecraft:red_flower:1'),item('minecraft:red_flower:2'),item('minecraft:red_flower:3'),item('minecraft:red_flower:4'),item('minecraft:red_flower:5'),item('minecraft:red_flower:6'),item('minecraft:red_flower:7'),item('minecraft:yellow_flower:0'),item('minecraft:double_plant:1'),item('futuremc:lily_of_the_valley:0'),item('futuremc:cornflower:0'),item('minecraft:double_plant:0'),item('minecraft:double_plant:4'),item('minecraft:double_plant:5'),item('minecraft:red_flower:8'),item('minecraft:waterlily:0'),ore('dye,dyeBrown')]as IItemStack[];
// 
// for i in plant{
// 
...
// h(item('enderio:item_capacitor_silver:0'));
// h(item('enderio:item_capacitor_energetic_silver:0'));
// //hide TE Dust
// h(ore('dustCoal'));
// h(ore('dustCharcoal'));
// h(ore('dustObsidian'));
...
// h(item('advancedrocketry:deployablerocketbuilder:0'));
// h(item('advancedrocketry:liquidtank:0'));
// h(item('advancedrocketry:intake:0'));
// h(item('advancedrocketry:terraformer'));
// h(ore('gearTitaniumAluminide'));
// h(item('advancedrocketry:spaceelevatorcontroller:0'));
// h(item('advancedrocketry:beacon:0'));
// h(item('advancedrocketry:blockpump:0'));
// h(item('advancedrocketry:centrifuge:0'));
// h(item('advancedrocketry:railgun:0'));
// h(item('advancedrocketry:forcefieldprojector:0'));
// h(item('advancedrocketry:forcefield:0'));
// h(item('advancedrocketry:lathe:0'));
// h(item('advancedrocketry:rollingmachine:0'));
// h(item('advancedrocketry:platepress:0'));
// h(item('advancedrocketry:electrolyser:0'));
// h(item('advancedrocketry:chemicalreactor:0'));
// h(item('advancedrocketry:planetanalyser:0'));
// h(item('advancedrocketry:satellitecontrolcenter:0'));
// h(item('advancedrocketry:blackholegenerator:0'));
// h(item('advancedrocketry:observatory:0'));
// h(item('advancedrocketry:cuttingmachine:0'));
// h(item('advancedrocketry:crystallizer:0'));
// h(item('advancedrocketry:loader:0'));
// h(item('enderio:item_data_conduit:0'));
// h(item('advancedrocketry:dataunit:0'));
// h(item('advancedrocketry:sawbladeiron:0'));
// h(item('advancedrocketry:satellitepowersource:0'));
...
// h(item('advancedrocketry:orescanner:0'));
// h(item('advancedrocketry:beaconfinder:0'));
// h(item('advancedrocketry:itemupgrade:4'));
// h(item('advancedrocketry:itemupgrade:0'));
// h(item('advancedrocketry:itemupgrade:1'));
// h(item('advancedrocketry:itemupgrade:2'));
// h(item('advancedrocketry:itemupgrade:3'));
// h(item('advancedrocketry:atmanalyser:0'));
// h(item('advancedrocketry:basiclasergun:0'));
// h(ore('sheetTitaniumIridium'));
// h(ore('blockTitaniumAluminide'));
// h(item('advancedrocketry:wirelesstransciever:0'));
// h(item('advancedrocketry:loader:2'));
// h(item('advancedrocketry:satellite:0'));
// h(ore('blockTitaniumIridium'));
// h(item('advancedrocketry:loader:3'));
// h(item('advancedrocketry:loader:6'));
// h(item('advancedrocketry:blastbrick:0'));
// h(item('advancedrocketry:iquartzcrucible:0'));
// h(item('advancedrocketry:precisionassemblingmachine:0'));
// h(item('advancedrocketry:satelliteprimaryfunction:0'));
// h(item('advancedrocketry:satellitebuilder:0'));
// h(item('libvulpes:hatch:1'));
// h(item('libvulpes:hatch:2'));
// h(item('libvulpes:hatch:3'));
// h(item('libvulpes:forgepoweroutput:0'));
// h(item('libvulpes:forgepowerinput:0'));
...
// h(ore('blockElectrum'));
// h(item('advancedrocketry:sawblade:0'));
// h(item('advancedrocketry:microwavereciever:0'));
// h(ore('bookshelf,bookshelfOak'));
// h(item('advancedrocketry:solargenerator:0'));
// h(ore('blockBronze'));
// h(item('advancedrocketry:pipesealer:0'));
// h(item('advancedrocketry:hovercraft'));
// h(item('advancedrocketry:jackhammer'));
// h(item('advancedrocketry:arcfurnace:0'));
// h(item('advancedrocketry:geode:0'));
// h(item('advancedrocketry:oxygendetection:0'));
// h(item('advancedrocketry:elevatorchip:0'));
// h(item('advancedrocketry:satelliteidchip:0'));
// h(item('advancedrocketry:asteroidchip:0'));
// h(ore('concrete'));
// h(item('advancedrocketry:monitoringstation:0'));
// h(item('advancedrocketry:biomescanner:0'));
// 
// h(item('advancedrocketry:planetholoselector:0'));
// h(item('advancedrocketry:ic:3'));
// h(item('advancedrocketry:ic:4'));
// h(item('advancedrocketry:ic:5'));
// h(item('advancedrocketry:planetselector:0'));
// 
// h(item('advancedrocketry:planetselector:0'));
// h(item('variegated:silvered_apple:0'));
...
// h(item('appliedenergistics2:vibration_chamber:0'));
// h(item('thermalfoundation:storage_resource:1'));
// h(item('thermalfoundation:material:802'));
// //h(item('danknull:dank_null_1:0'));
// h(item('danknull:dank_null_2:0'));
// h(item('danknull:dank_null_3:0'));
// h(item('danknull:dank_null_4:0'));
// h(item('danknull:dank_null_5:0'));
// h(item('danknull:dank_null_6:0'));
// //h(item('danknull:dank_null_panel_1:0'));
// h(item('danknull:dank_null_panel_2:0'));
// h(item('danknull:dank_null_panel_3:0'));
// h(item('danknull:dank_null_panel_4:0'));
// h(item('danknull:dank_null_panel_5:0'));
// h(item('danknull:danknull_dock:0'));
...
// h(item('actuallyadditions:block_atomic_reconstructor:0'));
// h(item('mob_grinding_utils:wither_muffler:0'));
// h(item('mob_grinding_utils:saw_upgrade:5'));
// h(item('mob_grinding_utils:gm_chicken_feed:0'));
// h(item('mob_grinding_utils:mob_swab:0'));
// h(item('mob_grinding_utils:dark_oak_stone:0'));
// h(item('mob_grinding_utils:saw_upgrade:1'));
// 
// //DE
// h(item('draconicevolution:draconium_chest:0'));
// h(item('draconicevolution:flow_gate:0'));
// h(item('draconicevolution:flow_gate:8'));
// h(item('draconicevolution:reactor_part:4'));
// h(item('draconicevolution:reactor_component:0'));
// h(item('draconicevolution:reactor_component:1'));
// h(item('draconicevolution:reactor_part:1'));
// h(item('draconicevolution:reactor_part:0'));
// h(item('draconicevolution:reactor_part:2'));
// h(item('draconicevolution:reactor_part:3'));
// h(item('draconicevolution:reactor_core:0'));
// h(item('draconicevolution:crafting_injector:2'));
// h(item('draconicevolution:crafting_injector:1'));
// h(item('draconicevolution:crafting_injector:0'));
// //h(item('draconicadditions:chaos_stabilizer_core:0'));
// h(item('gregtech:machine:811'));
// h(item('draconicadditions:basic_shield_necklace:0'));
// h(item('draconicadditions:wyvern_shield_necklace:0'));
// h(item('draconicadditions:draconic_shield_necklace:0'));
// h(item('draconicadditions:overload_belt:0'));
// h(item('draconicadditions:inertia_cancel_ring:0'));
// 
...
// h(item('enderio:block_solar_panel:0'));
...
// h(item('compactmachines3:machine:0'));