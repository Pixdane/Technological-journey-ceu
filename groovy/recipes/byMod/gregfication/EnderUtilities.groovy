...
crafting.shapedBuilder()
        .name(tjceu('handy_bag'))
        .row('IBI')
        .row('BCB')
        .row('IBI')
        .key('I', ore('ingotPulsatingIron'))
        .key('B', item('ironbackpacks:backpack')
                .withNbt(['packInfo': ['type': 'ironbackpacks:diamond', 'spec': 'STORAGE', 'upgrade': []]]))
        .key('C', ore('circuitHv'))
        .output(item('enderutilities:handybag'))
        .register()

crafting.addShaped(item('enderutilities:barrel'), [
        [ore('ingotPulsatingIron'), item('actuallyadditions:block_giant_chest'), ore('ingotPulsatingIron')],
        [item('actuallyadditions:block_giant_chest'), ore('chest,chestWood'), item('actuallyadditions:block_giant_chest')],
        [ore('ingotPulsatingIron'), item('actuallyadditions:block_giant_chest'), ore('ingotPulsatingIron')]
])
...
crafting.addShaped(item('enderutilities:enderpart', 72), [
        [ore('ingotPulsatingIron'), item('actuallyadditions:block_giant_chest'), ore('ingotPulsatingIron')],
        [item('actuallyadditions:block_giant_chest'), item('enderutilities:barrel'), item('actuallyadditions:block_giant_chest')],
        [ore('ingotPulsatingIron'), item('actuallyadditions:block_giant_chest'), ore('ingotPulsatingIron')]
])
