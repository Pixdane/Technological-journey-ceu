...
STELLAR_FORGE.recipeBuilder()
        .inputs(item('draconicevolution:awakened_core:0') * 3)
        .inputs(metaitem('tjceu:crystal.refined_chaos'))
...
STELLAR_FORGE.recipeBuilder()
        .inputs(item('draconicevolution:awakened_core:0'))
        .inputs(item('draconicadditions:chaos_heart:0'))
...
//    .inputs(item('draconicevolution:dragon_heart:0') * 2)
...
//STELLAR_FORGE.recipeBuilder()
//     .inputs(item('draconicevolution:wyvern_core:0') * 2)
...
//        .inputs(ore('circuitUev'))
//        .inputs(item('draconicevolution:awakened_core:0') * 2)
...
//ASSLINE.recipeBuilder()
//        .inputs(item('draconicevolution:wyvern_energy_core:0') * 4)
//        .inputs(item('draconicevolution:wyvern_core:0'))
...
//        .inputs(item('draconicevolution:dislocator:0'))
