...
LARGE_MIXER.recipeBuilder().with {
        fluidInputs fluid('dense_hydrazine_fuel_mixture') * 8000
        fluidInputs fluid('nitrotoluene') * 4000
        fluidInputs fluid('glyceryl_trinitrate') * 1000
...
// Octazacubane
CHEMICAL_DEHYDRATOR.recipeBuilder().with {
...
LCR.recipeBuilder().with {
        fluidInputs fluid('explosive_hydrazine_mixture') * 32000
        fluidInputs fluid('starlight_complex') * 6000
        fluidInputs fluid('rocket_fuel_b') * 2000
        fluidInputs fluid('kerosene') * 4000
        fluidInputs fluid('dinitrogen_tetroxide') * 6000
