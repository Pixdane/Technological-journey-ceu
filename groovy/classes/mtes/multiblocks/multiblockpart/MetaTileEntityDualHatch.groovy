...
public class MetaTileEntityDualHatch extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MetaTileEntityDualHatch(ResourceLocation metaTileEntityId, int tier, int numSlots,
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityDualHatch(metaTileEntityId, this.getTier(), numSlots, this.isExportHatch);
    }
